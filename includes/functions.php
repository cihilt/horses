...
function meeting_details($mid)
{
    global $mysqli;
    $meetingdet
        = $mysqli->query("SELECT * FROM `tbl_meetings` WHERE `meeting_id`='$mid'");
...
function horse_details($hid)
{
    global $mysqli;
    $horsedet
        = $mysqli->query("SELECT * FROM `tbl_horses` WHERE `horse_id`='$hid'");
...
function race_details($rid)
{
    global $mysqli;
    $racedet
        = $mysqli->query("SELECT * FROM `tbl_races` WHERE `race_id`='$rid'");
...
function result_details($rid, $hid)
{
    global $mysqli;
    $resdet
        = $mysqli->query("SELECT * FROM `tbl_results` WHERE `race_id`='$rid' AND `horse_id`='$hid'");
